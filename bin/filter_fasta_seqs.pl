...
# perl filter_fasta_seqs.pl -i ~/workspace/GBS_data-08-10-2013/MPB_GBS_Data-08-10-2013/MPB_GWAS/pgi/all_pgi_proteins.fasta -l 450 -o ~/workspace/GBS_data-08-10-2013/MPB_GBS_Data-08-10-2013/MPB_GWAS/pgi/
...
$min_length = 450 unless(defined($min_length));
